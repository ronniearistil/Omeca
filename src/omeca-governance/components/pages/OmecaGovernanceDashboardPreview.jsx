...
// --- Main Preview Component ---
const OmecaDashboardPreview = () => { // RENAMED COMPONENT
  const { mode } = useContext(ColorModeContext);
  const [totalSpend, setTotalSpend] = useState(4.2);
  const [unauditedSpend, setUnauditedSpend] = useState(0.02);
  const [efficiency, setEfficiency] = useState(87.0);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Omeca Audit Core {/* UNIFIED BRAND: Omeca */}
        </span>
      </Typography>
...
<Box sx={{ mt: 3, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
  ...
  >
    Metrics updating live every few seconds — powered by the Omeca prototype engine. {/* UNIFIED BRAND: Omeca */}
  </Typography>

  <Typography
    component="a"
    href="/omeca-dashboard" // CORRECTED ROUTE
    target="_blank"
    rel="noopener noreferrer"
    sx={{
      fontSize: '0.85rem',
...
export default OmecaDashboardPreview; // RENAMED EXPORT