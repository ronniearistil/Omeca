...
// src/Omeca/pages/PricingPage.jsx (Conceptual File Path & Name Change)
...
const OmecaPricingPage = ({ setPage }) => { // RENAMED COMPONENT
  const { mode } = useContext(ColorModeContext);
  const currentColors = colors[mode];

  // NOTE: Growth tier commented out in source, removing it here for consistency
  const tiers = [
    {
      name: 'Starter',
      price: 'Free',
...
export default OmecaPricingPage; // RENAMED EXPORT
