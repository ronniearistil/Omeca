// src/Melucra/components/sections/DeveloperIntegration.jsx

import React, { useContext } from 'react';
import { Container, Typography, Grid, Paper, Box, Button } from '@mui/material';
import { motion } from 'framer-motion';
// import { ColorModeContext } from '../../layouts/theme/ThemeContext';
// import { colors } from '../../layouts/theme/theme';
        ...
        <Container maxWidth="lg" sx={{ py: { xs: 8, md: 10 } }}>
            <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true, amount: 0.5 }}>
                {/* <Typography variant="h4" fontWeight={900} color={currentColors.textPrimary} sx={{ mb: 1, textAlign: 'center' }}>
                    Simple <span style={{ color: colors.accent }}>API Integration</span> for Financial Control
                </Typography> */}
                <Typography variant="h4" fontWeight={900} color={currentColors.textPrimary} sx={{ mb: 1, textAlign: 'center' }}>
