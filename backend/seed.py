...
# except ImportError:
#     print("Error: Could not import 'MachineEvent' from 'app.models.machine_event'.")
#     exit()
...
#         explanation=EXPLANATIONS_PASS if is_pass else EXPLANATIONS_FAIL,
#         
#         # --- FIX ---
#         # The 'raw_log', 'data', or 'log' column does not exist on your
#         # MachineEvent model, so it has been removed from this seeder.
#         # ---
#         
...
# 
#     try:
#         print(f"Clearing old events for tenant: {TENANT_TO_SEED}...")
#         db.query(MachineEvent).filter(MachineEvent.tenant_id == TENANT_TO_SEED).delete()
#         db.commit()
# 
